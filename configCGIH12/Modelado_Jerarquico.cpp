...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Dedo 1
		model = glm::translate(modelTemp, glm::vec3(0.25f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(dedo), glm::vec3(1.0f, 0.0, 0.0f)); //dedo
		...
		model = glm::translate(modelTemp, glm::vec3(0.25f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(FB1), glm::vec3(1.0f, 0.0, 0.0f)); //FB1
		modelTemp = model = glm::translate(model, glm::vec3(0.25f, 0.0f, 0.0f));
		...
		// Dedo 2
		model = glm::translate(modelTemp, glm::vec3(0.25f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(dedo), glm::vec3(1.0f, 0.0f, 0.0f));
		modelTemp = glm::translate(model, glm::vec3(0.25f, 1.0f, 1.0f));
		model = glm::scale(modelTemp, glm::vec3(0.6f, 0.2f, 0.2f));
		...
		//model = glm::rotate(model, glm::radians(dedo2), glm::vec3(1.0f, 0.0, 0.0f)); //dedo
		//modelTemp2 = model = glm::translate(model, glm::vec3(0.25f, 1.0f, 0.0f));
		//model = glm::scale(model, glm::vec3(0.6f, 0.2f, 0.2f));
		//color = glm::vec3(0.0f, 1.0f, 1.0f);
		//glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		//glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		//model = glm::translate(modelTemp2, glm::vec3(0.25f, 0.0f, 0.0f));
		//model = glm::rotate(model, glm::radians(FB2), glm::vec3(1.0f, 0.0, 0.0f)); //FB2
		//modelTemp2 = model = glm::translate(model, glm::vec3(0.25f, 1.0f, 0.0f));
		//model = glm::scale(model, glm::vec3(0.4f, 0.2f, 0.2f));
		//color = glm::vec3(0.0f, 0.0f, 1.0f);
		//glUniform3fv(uniformColor, 1, glm::value_ptr(color));
