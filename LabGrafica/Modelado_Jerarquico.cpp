...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Modelado jerarquico - Brazo Robot", nullptr, nullptr);
	...
	std::cout << "Version de OpenGL: "
		<< glGetString(GL_VERSION) << std::endl;

	std::cout << "Fabricante: "
		<< glGetString(GL_VENDOR) << std::endl;

	std::cout << "Tarjeta grafica: "
		<< glGetString(GL_RENDERER) << std::endl;

	std::cout << "Version de GLSL: "
